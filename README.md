basic example of Netflix's Vizceral data visualization tool, running in docker container, orchestrated by kubernetes


TO DEPLOY docker image build --rm -t apps-talk:2 .
cd deployment.yaml and change to- image: "apps-talk:2"
kubectl get deployments
kubectl delete deployment apps-talk
